...
The central argument is simple and contestable: the professional advantage in The Research Paper Recipe no longer comes from doing every step by hand. It comes from knowing what to delegate, what to verify, what to reject, and what human judgment must still own because the consequences attach to a person, a community, an institution, or a client.
...
The Research Paper Recipe is a guided course in the concepts, workflows, and judgment calls that define The Research Paper Recipe in the AI era. It teaches vocabulary, recurring patterns, practical exercises, and the discipline of checking machine output against human purpose.
...
2. **Chapter 1** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
...
The Research Paper Recipe, AI+1, Humanitarians AI, Irreducibly Human, agentic AI, computational skepticism
