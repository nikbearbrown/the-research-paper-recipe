...
The cost of skipping that question is not just personal. In their analysis of waste in biomedical research, Chalmers and Glasziou (2009) put the relevance and framing of the research question first among the four stages at which scientific effort is squandered, and estimated that something on the order of 85 percent of research investment is wasted — much of it traceable to questions that were never worth asking in the form they were asked. A weak question is not only intellectually empty. It is expensive.
...
Falsifiability is the test that a question or hypothesis has *edges*, but it is not the only thing you need to ask of a candidate question, and it is worth having a portable checklist for the rest. Two are widely taught. The first is FINER (Hulley and colleagues, *Designing Clinical Research*): a good question should be **F**easible, **I**nteresting, **N**ovel, **E**thical, and **R**elevant. Falsifiability tells you the question is testable; FINER tells you whether it is worth testing — whether you can actually do it, whether anyone learns anything if you do, and whether the answer changes anything. The second is PICO — **P**opulation, **I**ntervention, **C**omparison, **O**utcome — the framework evidence-based medicine uses to force a clinical question into answerable shape. You have already seen PICO without the name: when I said a research question needs "a variable, a population, and an outcome," that is most of it; PICO simply adds the comparison and makes the four parts explicit. Maya's question — *does Socratic AI feedback (intervention) improve programming retention (outcome) for undergraduates (population) compared to direct-answer feedback (comparison)?* — is a PICO question, and naming it that way makes the structure portable to whatever field you write in.
...
There is a related failure that the preregistration literature gives a name to. Nosek and colleagues (2018) distinguish *confirmatory* research — where the hypothesis is fixed before the data are seen — from *exploratory* research, where the data suggest the patterns. Both are legitimate. The trouble is HARKing: Hypothesizing After the Results are Known, then presenting the hypothesis as though it had been there all along. HARKing inflates confidence in a finding that was actually generated by the result it claims to predict. Letting an AI read your data, your draft, or your half-formed results and *then* hand you the hypothesis is a fast, frictionless way to HARK without noticing — the claim comes out fitted to what you already have, dressed as a prediction. Preregistration is the institutional defense against this: you state the falsification condition before you see the result. Doing the hypothesis work yourself, first, is the personal version of the same discipline.

Call this the **defend-it-without-notes-or-AI test**: can you explain, out loud and from memory, why this hypothesis and not a related alternative? If you need your notes, fine. If you need the AI, the AI did the work that should have been yours.
...
And there is a sharper way to name what you are avoiding. A claim that can't fail is not a hypothesis — it is advocacy. The word matters because it names the motive, not just the logical defect: a claim with no failure condition is one you have decided to argue for regardless of what the evidence does. That is a fine posture for an op-ed and a fatal one for a paper. The moment your hypothesis can survive any result, you have stopped doing research and started campaigning.
...
What this chapter has been building is the first layer of a schema you will assemble across the next two chapters — call it the **intent layer**: what you are claiming and what would count against it. The next chapter builds the **evidence layer**: whether the sources and the design you have can actually carry the claim. Intent without evidence is a wish; evidence without intent is a pile of facts. You need both, and they go in this order.
...
- Hulley, S. B., Cummings, S. R., Browner, W. S., Grady, D. G., & Newman, T. B. *Designing Clinical Research* (FINER criteria for research questions). Wolters Kluwer.
- Richardson, W. S., Wilson, M. C., Nishikawa, J., & Hayward, R. S. (1995). The well-built clinical question: A key to evidence-based decisions. *ACP Journal Club*, 123(3), A12–A13. (PICO framework.)
...
>
> **This chapter adds:** a sharpened, testable research question and a first hypothesis for *your* paper — the seed everything else grows from.
>
> **Carries into the next chapter:** Chapter 2 turns that question into an explicit evidence plan.

> **CRITIQ (Appendix).** Stuck turning a hunch into a testable question? Load CRITIQ and run `/brainstorm` to move from curiosity to a research question with teaching at each step, or `/idea` to shape it into a structured proposal — then bring the result back to *your* paper. It will flag a claim that cannot fail; you decide the question.
